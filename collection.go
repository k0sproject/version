...
// All returns all known k0s versions. It refreshes the local cache by querying
// GitHub for tags newer than the cache modification time when the cache is
// older than CacheMaxAge. The cache is skipped if the remote lookup fails and
// no cached data exists.
func All() (Collection, error) {
...
func loadAll(force bool) (loadResult, error) {
	...
	tags, err := client.TagsSince(modTime)
	if err != nil {
